    ...
    <div>
      <div style={S.card}>
        ...
        <p style={{ fontSize: 12, color: '#888', marginBottom: 14 }}>
          Required: <code>Employee Code, Name, Employment Unit, Department, Division, Section,
          Position Title, Grade, Category, Country, Work Location, Employee Type, Hire Date, Gender, ROLE</code>
          <br />
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          {summary && (
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              ...
              {filter && (
                <button style={{ fontSize: 12, color: '#888', background: 'transparent', border: 'none', cursor: 'pointer' }}
        ...
        <div style={S.card}>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
              <thead>
                <tr style={{ background: '#fafaf8' }}>
                  {['', 'Status', 'Code', 'Name', 'Email', 'Dept', 'Grade', 'Role', 'DM Code', 'Notes'].map(h => (
              ...
              <tbody>
                {filtered.map((row: any, i: number) => {
                  ...
                  return (
                    <tr key={i} style={{ background: isSel ? '#f0fdf4' : i % 2 === 0 ? '#fff' : '#fafaf8' }}>
      ...
      <div style={{ marginLeft: depth * 20 }}>
        <div
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 10px',
            borderRadius: 8, cursor: reports.length > 0 ? 'pointer' : 'default', marginBottom: 2,
      ...
      {tab === 'cycles' && (
        <div>
          ...
          <div style={S.card}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr>{['Name', 'Year', 'Status', 'KPI Window'].map(h => <th key={h} style={S.th}>{h}</th>)}</tr>
              </thead>
              <tbody>
