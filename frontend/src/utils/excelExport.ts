...
const CUSTOM_REPORT_COLUMN_LABELS: Record<string, string> = {
  ...
  kpi_type:                  'KPI Type',
  rating_target_1:           'Rating 1 (Target)',
  rating_target_2:           'Rating 2 (Target)',
  rating_target_3:           'Rating 3 (Target)',
  rating_target_4:           'Rating 4 (Target)',
  rating_target_5:           'Rating 5 (Target)',
